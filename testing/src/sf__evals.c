...
void PyGSL_sf_ufunc_pd_d_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_f__as_d_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] ;
	char   *ip0=args[0] , *op0=args[1] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_dd_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_ff__as_dd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_ddd_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_fff__as_ddd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_dddd_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_ffff__as_dddd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_ddddm_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_ffffm__as_ddddm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , is4=steps[4] , os0=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *ip4=args[4] , *op0=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,ip4+=is4 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_dddm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_fffm__as_dddm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_ddm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_ffm__as_ddm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_di_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_fi__as_di_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_dm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_fm__as_dm_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_dui_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_fui__as_dui_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_i_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] ;
	char   *ip0=args[0] , *op0=args[1] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_i__as_i_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] ;
	char   *ip0=args[0] , *op0=args[1] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_id_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_if__as_id_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_idd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iff__as_idd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iid_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iif__as_iid_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iidd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iiff__as_iidd_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iiiiii_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_iiiiii__as_iiiiii_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , is4=steps[4] , is5=steps[5] , os0=steps[6] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *ip4=args[4] , *ip5=args[5] , *op0=args[6] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,ip4+=is4 ,ip5+=is5 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_iiiiiiiii_ (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_pd_iiiiiiiii__as_iiiiiiiii_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , is4=steps[4] , is5=steps[5] , is6=steps[6] , is7=steps[7] , is8=steps[8] , os0=steps[9] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *ip4=args[4] , *ip5=args[5] , *ip6=args[6] , *ip7=args[7] , *ip8=args[8] , *op0=args[9] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,ip4+=is4 ,ip5+=is5 ,ip6+=is6 ,ip7+=is7 ,ip8+=is8 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_ui_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] ;
	char   *ip0=args[0] , *op0=args[1] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_ui__as_ui_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] ;
	char   *ip0=args[0] , *op0=args[1] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_uiui_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_pd_uiui__as_uiui_ (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ){
...
void PyGSL_sf_ufunc_qi_d_rdd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_f_rff_as_d_rdd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] , os1=steps[2] , os2=steps[3] ;
	char   *ip0=args[0] , *op0=args[1] , *op1=args[2] , *op2=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_dd_ddd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_ff_fff_as_dd_ddd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] , os2=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] , *op2=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_dd_rd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_ff_rf_as_dd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_dd_rdd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] , os2=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] , *op2=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_ff_rff_as_dd_rdd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] , os2=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] , *op2=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_ddd_erd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_fff_erf_as_ddd_erd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] , os2=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] , *op2=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_ddd_rd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_fff_rf_as_ddd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_dddd_rd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_ffff_rf_as_dddd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_ddddm_rd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_ffffm_rf_as_ddddm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , is4=steps[4] , os0=steps[5] , os1=steps[6] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *ip4=args[4] , *op0=args[5] , *op1=args[6] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,ip4+=is4 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_dddi_rdrdrdrddd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_fffi_rfrfrfrfff_as_dddi_rdrdrdrddd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] , os2=steps[6] , os3=steps[7] , os4=steps[8] , os5=steps[9] , os6=steps[10] , os7=steps[11] , os8=steps[12] , os9=steps[13] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] , *op2=args[6] , *op3=args[7] , *op4=args[8] , *op5=args[9] , *op6=args[10] , *op7=args[11] , *op8=args[12] , *op9=args[13] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ,op2+=os2 ,op3+=os3 ,op4+=os4 ,op5+=os5 ,op6+=os6 ,op7+=os7 ,op8+=os8 ,op9+=os9 ){
		{
...
void PyGSL_sf_ufunc_qi_dddm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_fffm_rf_as_dddm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_ddm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_ffm_rf_as_ddm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_di_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_fi_rf_as_di_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_dm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_fm_rf_as_dm_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_dui_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_fui_rf_as_dui_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_i_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] , os1=steps[2] ;
	char   *ip0=args[0] , *op0=args[1] , *op1=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_i_rf_as_i_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] , os1=steps[2] ;
	char   *ip0=args[0] , *op0=args[1] , *op1=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_id_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_if_rf_as_id_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_idd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iff_rf_as_idd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iid_erd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] , os2=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] , *op2=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_iif_erf_as_iid_erd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] , os2=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] , *op2=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		{
...
void PyGSL_sf_ufunc_qi_iid_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iif_rf_as_iid_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iidd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iiff_rf_as_iidd_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iiiiii_rd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_iiiiii_rf_as_iiiiii_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , is4=steps[4] , is5=steps[5] , os0=steps[6] , os1=steps[7] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *ip4=args[4] , *ip5=args[5] , *op0=args[6] , *op1=args[7] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,ip4+=is4 ,ip5+=is5 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_iiiiiiiii_rd (char **args, int *dimensions, int *steps, void *func){
...
void PyGSL_sf_ufunc_qi_iiiiiiiii_rf_as_iiiiiiiii_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , is4=steps[4] , is5=steps[5] , is6=steps[6] , is7=steps[7] , is8=steps[8] , os0=steps[9] , os1=steps[10] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *ip4=args[4] , *ip5=args[5] , *ip6=args[6] , *ip7=args[7] , *ip8=args[8] , *op0=args[9] , *op1=args[10] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,ip4+=is4 ,ip5+=is5 ,ip6+=is6 ,ip7+=is7 ,ip8+=is8 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_ui_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] , os1=steps[2] ;
	char   *ip0=args[0] , *op0=args[1] , *op1=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_ui_rf_as_ui_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , os0=steps[1] , os1=steps[2] ;
	char   *ip0=args[0] , *op0=args[1] , *op1=args[2] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_uiui_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
...
void PyGSL_sf_ufunc_qi_uiui_rf_as_uiui_rd (char **args, int *dimensions, int *steps, void *func){
	int i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ){
		{
