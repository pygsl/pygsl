...
static void * sf_bessel_Knu_scaled_e10_e_data [] = {(void *) gsl_sf_bessel_Knu_scaled_e10_e, (void *) gsl_sf_bessel_Knu_scaled_e10_e};
...
static void * sf_mathieu_ce_data [] = {(void *) gsl_sf_mathieu_ce, (void *) gsl_sf_mathieu_ce};
...
static char PyGSL_sf_ufunc_pd_ddddm__one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, 
                                                     NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_dddm__one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, 
                                                    NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_ddm__one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, 
                                                   NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_di__one_types [] = { NPY_FLOAT, NPY_LONG, NPY_FLOAT, 
...
static char PyGSL_sf_ufunc_pd_dm__one_types [] = { NPY_FLOAT, NPY_LONG, NPY_FLOAT, 
                                                  NPY_DOUBLE, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_dui__one_types [] = { NPY_FLOAT, NPY_LONG, NPY_FLOAT, 
                                                   NPY_DOUBLE, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_i__one_types [] = { NPY_LONG, NPY_FLOAT, 
                                                 NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_id__one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
...
static char PyGSL_sf_ufunc_pd_idd__one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                   NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_iid__one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                   NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_iidd__one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                    NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_iiiiii__one_types [] = { NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_FLOAT, 
                                                      NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_iiiiiiiii__one_types [] = { NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_FLOAT, 
                                                         NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_ui__one_types [] = { NPY_LONG, NPY_FLOAT, 
                                                  NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pd_uiui__one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, 
                                                    NPY_LONG, NPY_LONG, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_pi_iddd__one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, 
                                                    NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG};
...
static char PyGSL_sf_ufunc_qi_d_erd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, 
                                                    NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG};
...
static char PyGSL_sf_ufunc_qi_dd_erd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, 
                                                     NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG};
...
static char PyGSL_sf_ufunc_qi_ddd_erd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, 
                                                      NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG};
...
static char PyGSL_sf_ufunc_qi_dddd_erd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, 
                                                       NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG};
...
static char PyGSL_sf_ufunc_qi_ddddm_rd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                       NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_dddi_rdrdrdrddd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                              NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_dddm_rd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                      NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_ddm_rd_one_types [] = { NPY_FLOAT, NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                     NPY_DOUBLE, NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_di_rd_one_types [] = { NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                    NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_dm_rd_one_types [] = { NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                    NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_dui_rd_one_types [] = { NPY_FLOAT, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                     NPY_DOUBLE, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_i_rd_one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                   NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_id_rd_one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                    NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_idd_rd_one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                     NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_iid_erd_one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_LONG, 
                                                      NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_LONG};
...
static char PyGSL_sf_ufunc_qi_iid_rd_one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                     NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_iidd_rd_one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, NPY_FLOAT, 
                                                      NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_iiiiii_rd_one_types [] = { NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                        NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_iiiiiiiii_rd_one_types [] = { NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                           NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_ui_rd_one_types [] = { NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                    NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
...
static char PyGSL_sf_ufunc_qi_uiui_rd_one_types [] = { NPY_LONG, NPY_LONG, NPY_FLOAT, NPY_FLOAT, 
                                                      NPY_LONG, NPY_LONG, NPY_DOUBLE, NPY_DOUBLE};
