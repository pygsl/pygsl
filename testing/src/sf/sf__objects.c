...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_pd_iiiiii__one_data ,
                             ...
                             PyGSL_sf_ufunc_pd_iiiiii__one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "coupling_6j_INCORRECT", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_dd_rdrd_one_data ,
                             ...
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "complex_dilog_xy_e", f);
/* Py_DECREF(f) */;

f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_dd_rdrd_one_data ,
                             complex_spence_xy_e_data,
                             PyGSL_sf_ufunc_qi_dd_rdrd_one_types,
                             2, /* number of supported types */
                             2, /* in args */
                             4, /* out args */
                             ...
                             PyGSL_sf_ufunc_qi_dd_rdrd_one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "complex_spence_xy_e", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_d_rd_one_data ,
                             ...
                             PyGSL_sf_ufunc_qi_d_rd_one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "hazard_e", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_pd_d__one_data ,
                             ...
                             PyGSL_sf_ufunc_pd_d__one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "hazard", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_dd_rd_one_data ,
                             ...
                             PyGSL_sf_ufunc_qi_dd_rd_one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "gamma_inc_e", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_pd_dd__one_data ,
                             ...
                             PyGSL_sf_ufunc_pd_dd__one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "gamma_inc", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_d_rd_one_data ,
                             ...
                             PyGSL_sf_ufunc_qi_d_rd_one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "psi_1_e", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_pd_d__one_data ,
                             ...
                             PyGSL_sf_ufunc_pd_d__one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "psi_1", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_d_rd_one_data ,
                             ...
                             PyGSL_sf_ufunc_qi_d_rd_one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "zetam1_e", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_pd_d__one_data ,
                             ...
                             PyGSL_sf_ufunc_pd_d__one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "zetam1", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_qi_i_rd_one_data ,
                             ...
                             PyGSL_sf_ufunc_qi_i_rd_one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "zetam1_int_e", f);
/* Py_DECREF(f) */;
...
f = PyUFunc_FromFuncAndData( PyGSL_sf_ufunc_pd_i__one_data ,
                             ...
                             PyGSL_sf_ufunc_pd_i__one_doc ,
                             0 /*check return*/); 
PyDict_SetItemString(sf_dict, "zetam1_int", f);
/* Py_DECREF(f) */;
...
PyGSL_sf_ufunc_qi_dd_rdrd_one_data[0] = PyGSL_sf_ufunc_qi_ff_rfrf_as_dd_rdrd;
PyGSL_sf_ufunc_qi_dd_rdrd_one_data[1] = PyGSL_sf_ufunc_qi_dd_rdrd;
