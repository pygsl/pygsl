...
if _t_func != None:
    class test_sf_automatic_legendre_sphPlm_e(_test_sf_automatic):
        ...
        def test_args16(self):
            '(s, gsl_sf_legendre_sphPlm_e, (140,135,0.99998689456491752,&r), -6.54265253269093276310395668335e-305, TEST_TOL6, GSL_SUCCESS)'            
            self._test((140, 135, 0.9999868945649175), -6.54265253269093276310395668335e-305, TEST_TOL6, GSL_SUCCESS)
