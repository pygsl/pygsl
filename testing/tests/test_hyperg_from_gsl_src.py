...
if _t_func != None:
    class test_sf_automatic_hyperg_1F1_e(_test_sf_automatic):
        ...
        def test_args36(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, 1.1, -101, &r), -2.3916306291344452490e-24, 0.04, GSL_SUCCESS)'            
            self._test((100, 1.1, -101), -2.3916306291344452490e-24, 0.04, GSL_SUCCESS)


        def test_args37(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, 1.1, -110, &r), -4.517581986037732280e-26, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, 1.1, -110), -4.517581986037732280e-26, TEST_TOL0, GSL_SUCCESS)


        def test_args38(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, 10.1, -220, &r), -4.296130300021696573e-64, TEST_TOL1, GSL_SUCCESS)'            
            self._test((100, 10.1, -220), -4.296130300021696573e-64, TEST_TOL1, GSL_SUCCESS)
        ...
        def test_args45(self):
            '(s, gsl_sf_hyperg_1F1_e, (-8.1, -1000.1, -10.0, &r),  0.9218280185080036020, TEST_TOL0, GSL_SUCCESS)'            
            self._test((-8.1, -1000.1, -10.0), 0.9218280185080036020, TEST_TOL0, GSL_SUCCESS)
        ...
        def test_args54(self):
            '(s, gsl_sf_hyperg_1F1_e, (-100, -50.1, 50, &r),  -7.564755600940346649e+36, TEST_TOL3, GSL_SUCCESS)'            
            self._test((-100, -50.1, 50), -7.564755600940346649e+36, TEST_TOL3, GSL_SUCCESS)


        def test_args55(self):
            '(s, gsl_sf_hyperg_1F1_e, (-100, -50.1, 100, &r),  4.218776962675977e+55, TEST_TOL3, GSL_SUCCESS)'            
            self._test((-100, -50.1, 100), 4.218776962675977e+55, TEST_TOL3, GSL_SUCCESS)


        def test_args56(self):
        ...
        def test_args63(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, -10.1, 1, &r),  -2.1213846338338567395e+12, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, -10.1, 1), -2.1213846338338567395e+12, TEST_TOL0, GSL_SUCCESS)


        def test_args64(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, -10.1, 10, &r),  -6.624849346145112398e+39, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, -10.1, 10), -6.624849346145112398e+39, TEST_TOL0, GSL_SUCCESS)


        def test_args65(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, -10.1, 100, &r),  -1.2413466759089171904e+129, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, -10.1, 100), -1.2413466759089171904e+129, TEST_TOL0, GSL_SUCCESS)


        def test_args66(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, -10.1, -1, &r),  34456.29405305551691, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, -10.1, -1), 34456.29405305551691, TEST_TOL0, GSL_SUCCESS)


        def test_args67(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, -10.1, -10, &r),  -7.809224251467710833e+07, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, -10.1, -10), -7.809224251467710833e+07, TEST_TOL0, GSL_SUCCESS)


        def test_args68(self):
            '(s, gsl_sf_hyperg_1F1_e, (100, -10.1, -100, &r),   -5.214065452753988395e-07, TEST_TOL0, GSL_SUCCESS)'            
            self._test((100, -10.1, -100), -5.214065452753988395e-07, TEST_TOL0, GSL_SUCCESS)


        def test_args69(self):
        ...
        def test_args83(self):
            '(s, gsl_sf_hyperg_1F1_e, (-26.1, 2.0, 100.0, &r), 1.341557199575986995e+19, TEST_TOL3, GSL_SUCCESS)'            
            self._test((-26.1, 2.0, 100.0), 1.341557199575986995e+19, TEST_TOL3, GSL_SUCCESS)


        def test_args84(self):
        ...
        def test_args87(self):
            '(s, gsl_sf_hyperg_1F1_e, (1.1, 1000000.5, 1001000.5, &r), 7304.6126942641350122, TEST_TOL3, GSL_SUCCESS)'            
            self._test((1.1, 1000000.5, 1001000.5), 7304.6126942641350122, TEST_TOL3, GSL_SUCCESS)


        def test_args88(self):
            '(s, gsl_sf_hyperg_1F1_e, (0.9, 1000000.5, 1001000.5, &r), 1645.4879293475410982, TEST_TOL3, GSL_SUCCESS)'            
            self._test((0.9, 1000000.5, 1001000.5), 1645.4879293475410982, TEST_TOL3, GSL_SUCCESS)


        def test_args89(self):
        ...
        def test_args96(self):
            '(s, gsl_sf_hyperg_1F1_e, (-37.8, 2.01, 103.58, &r), -6.21927211009e17, TEST_TOL1, GSL_SUCCESS)'            
            self._test((-37.8, 2.01, 103.58), -6.21927211009e17, TEST_TOL1, GSL_SUCCESS)


        def test_args97(self):
            '(s, gsl_sf_hyperg_1F1_e, (-1, -1, 0.1, &r),  1.1, TEST_TOL0, GSL_SUCCESS)'            
...
if _t_func != None:
    class test_sf_automatic_hyperg_1F1_int_e(_test_sf_automatic):
        ...
        def test_args77(self):
            '(s, gsl_sf_hyperg_1F1_int_e, (-1, -1, 0.1, &r), 1.1, TEST_TOL0, GSL_SUCCESS)'            
            self._test((-1, -1, 0.1), 1.1, TEST_TOL0, GSL_SUCCESS)
