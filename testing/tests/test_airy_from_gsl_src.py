...
if _t_func != None:
    class test_sf_automatic_airy_Ai_e(_test_sf_automatic):
        ...
        def test_args4(self):
            '(s, gsl_sf_airy_Ai_e, (1.649999999999991, m, &r),   0.05831058618720882,   TEST_TOL0, GSL_SUCCESS)'            
            self._test((1.649999999999991, 'GSL_MODE_DEFAULT'), 0.05831058618720882, TEST_TOL0, GSL_SUCCESS)
