...
.. py:function:: sf_synchrotron_2(x [, ret])

    Wrapper for :c:func:`gsl_sf_synchrotron_2`
    c code signature: double gsl_sf_synchrotron_2(const double x)
...
.. py:function:: sf_synchrotron_1(x [, ret])
    ...
    c code signature: double gsl_sf_synchrotron_1(const double x)
    Wrapped by ufunc :class:`PyGSL_sf_ufunc_Id__Rd__O`
