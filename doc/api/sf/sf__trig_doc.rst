...
.. py:function:: sf_angle_restrict_symm_e( [, ret, theta])

    Wrapper for :c:func:`gsl_sf_angle_restrict_symm_e`
    c code signature: int gsl_sf_angle_restrict_symm_e(double* theta)
    Wrapped by ufunc :class:`PyGSL_sf_ufunc_I__Rl__Od`
    
    :param int ret: positional argument 0
    :param double theta: positional argument 1
    :rtype:  tuple(:param int ret: positional argument 0, :param double theta: positional argument 1) 
    :return: result 
