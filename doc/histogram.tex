...
\newcommand{\refhistogramindex}[2]{\texttt{#2}\index{#2@\texttt{#2} (#1)}}
...
\index{histogram@\class{histogram} (pygsl.histogram)}
...
\index{histogram2d@\class{histogram2d} (pygsl.histogram)}
