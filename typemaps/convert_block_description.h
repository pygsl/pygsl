...
enum {
gsl_vector_complex_long_double_py_array_type       = NPY_CLONGDOUBLE,
gsl_vector_complex_double_py_array_type            = NPY_CDOUBLE ,
gsl_vector_complex_float_py_array_type             = NPY_CFLOAT  ,
gsl_vector_complex_py_array_type                   = NPY_CDOUBLE ,
gsl_vector_long_double_py_array_type               = NPY_LONGDOUBLE,
gsl_vector_double_py_array_type                    = NPY_DOUBLE  ,
gsl_vector_float_py_array_type                     = NPY_FLOAT   ,
gsl_vector_py_array_type                           = NPY_DOUBLE  ,
gsl_vector_ulong_py_array_type                     = NPY_ULONG  ,
gsl_vector_long_py_array_type                      = NPY_LONG    ,
gsl_vector_uint_py_array_type                      = NPY_UINT  ,
gsl_vector_int_py_array_type                       = NPY_INT     ,
gsl_vector_ushort_py_array_type                    = NPY_USHORT  ,
gsl_vector_short_py_array_type                     = NPY_SHORT   ,
gsl_vector_uchar_py_array_type                     = NPY_UBYTE  ,
gsl_vector_char_py_array_type                      = NPY_BYTE    ,

gsl_vector_complex_long_double_view_py_array_type  = NPY_CLONGDOUBLE,
gsl_vector_complex_double_view_py_array_type       = NPY_CDOUBLE ,
gsl_vector_complex_float_view_py_array_type        = NPY_CFLOAT  ,
gsl_vector_complex_view_py_array_type              = NPY_CDOUBLE ,
gsl_vector_long_double_view_py_array_type          = NPY_LONGDOUBLE,
gsl_vector_double_view_py_array_type               = NPY_DOUBLE  ,
gsl_vector_float_view_py_array_type                = NPY_FLOAT   ,
gsl_vector_view_py_array_type                      = NPY_DOUBLE  ,
gsl_vector_ulong_view_py_array_type                = NPY_ULONG  ,
gsl_vector_long_view_py_array_type                 = NPY_LONG    ,
gsl_vector_uint_view_py_array_type                 = NPY_UINT  ,
gsl_vector_int_view_py_array_type                  = NPY_INT     ,
gsl_vector_ushort_view_py_array_type               = NPY_USHORT  ,
gsl_vector_short_view_py_array_type                = NPY_SHORT   ,
gsl_vector_uchar_view_py_array_type                = NPY_UBYTE  ,
gsl_vector_char_view_py_array_type                 = NPY_BYTE    ,
...
enum {
gsl_matrix_complex_long_double_py_array_type       = NPY_CLONGDOUBLE,
gsl_matrix_complex_double_py_array_type            = NPY_CDOUBLE ,
gsl_matrix_complex_float_py_array_type             = NPY_CFLOAT  ,
gsl_matrix_complex_py_array_type                   = NPY_CDOUBLE ,
gsl_matrix_long_double_py_array_type               = NPY_LONGDOUBLE,
gsl_matrix_double_py_array_type                    = NPY_DOUBLE  ,
gsl_matrix_float_py_array_type                     = NPY_FLOAT   ,
gsl_matrix_py_array_type                           = NPY_DOUBLE  ,
gsl_matrix_ulong_py_array_type                     = NPY_ULONG  ,
gsl_matrix_long_py_array_type                      = NPY_LONG    ,
gsl_matrix_uint_py_array_type                      = NPY_UINT  ,
gsl_matrix_int_py_array_type                       = NPY_INT     ,
gsl_matrix_ushort_py_array_type                    = NPY_USHORT  ,
gsl_matrix_short_py_array_type                     = NPY_SHORT   ,
gsl_matrix_uchar_py_array_type                     = NPY_UBYTE  ,
gsl_matrix_char_py_array_type                      = NPY_BYTE    ,

gsl_matrix_complex_long_double_view_py_array_type  = NPY_CLONGDOUBLE,
gsl_matrix_complex_double_view_py_array_type       = NPY_CDOUBLE ,
gsl_matrix_complex_float_view_py_array_type        = NPY_CFLOAT  ,
gsl_matrix_complex_view_py_array_type              = NPY_CDOUBLE ,
gsl_matrix_long_double_view_py_array_type          = NPY_LONGDOUBLE,
gsl_matrix_double_view_py_array_type               = NPY_DOUBLE  ,
gsl_matrix_float_view_py_array_type                = NPY_FLOAT   ,
gsl_matrix_view_py_array_type                      = NPY_DOUBLE  ,
gsl_matrix_ulong_view_py_array_type                = NPY_ULONG  ,
gsl_matrix_long_view_py_array_type                 = NPY_LONG    ,
gsl_matrix_uint_view_py_array_type                 = NPY_UINT  ,
gsl_matrix_int_view_py_array_type                  = NPY_INT     ,
gsl_matrix_ushort_view_py_array_type               = NPY_USHORT  ,
gsl_matrix_short_view_py_array_type                = NPY_SHORT   ,
gsl_matrix_uchar_view_py_array_type                = NPY_UBYTE  ,
gsl_matrix_char_view_py_array_type                 = NPY_BYTE    ,
