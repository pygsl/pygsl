...
#define SWIGTYPE_p_pygsl_odeiv2_control swig_types[4]
#define SWIGTYPE_p_pygsl_odeiv2_driver swig_types[5]
#define SWIGTYPE_p_pygsl_odeiv2_evolve swig_types[6]
#define SWIGTYPE_p_pygsl_odeiv2_step swig_types[7]
#define SWIGTYPE_p_pygsl_odeiv2_system swig_types[8]
...
SWIGINTERN pygsl_odeiv2_step *new_pygsl_odeiv2_step(gsl_odeiv2_step_type const *T,size_t dim){
		if(T == NULL){
			pygsl_error("Type None/NULL not accepted", "src/callback/gsl_odeiv2.i", 274 -1, GSL_EINVAL);
			return NULL;
		}
...
SWIGINTERN PyObject *pygsl_odeiv2_control_hadjust(pygsl_odeiv2_control *self,pygsl_odeiv2_step *s,PyObject *y_o,PyObject *yerr_o,PyObject *dydt_o,double h_in){
		...
		if(dim != self->dimension){
			pygsl_error("dimension of step and control do not match!", "src/callback/gsl_odeiv2.i", 515-1, GSL_EINVAL);
		}
...
SWIGINTERN PyObject *pygsl_odeiv2_evolve_apply(pygsl_odeiv2_evolve *self,pygsl_odeiv2_control *con,pygsl_odeiv2_step *step,pygsl_odeiv2_system const *sys,double const t_in,double const t1,double const h_in,PyObject *y_in_o){
		...
		if(con == NULL){
			pygsl_error("control object not set?", "src/callback/gsl_odeiv2.i", 609, GSL_EINVAL);
			line = 610 - 2; goto fail;
		}
		if(step == NULL){
			pygsl_error("step object not set?", "src/callback/gsl_odeiv2.i", 613, GSL_EINVAL);
			line = 614 - 2; goto fail;
		}
		if(sys == NULL){
			pygsl_error("sys object not set?", "src/callback/gsl_odeiv2.i", 617, GSL_EINVAL);
		...
		if(sys->dydt.dimension != dim){
			pygsl_error("sys dimension does not match evolve dimension", "src/callback/gsl_odeiv2.i", 628, GSL_EINVAL);
...
SWIGINTERN PyObject *pygsl_odeiv2_evolve_apply_fixed_step(pygsl_odeiv2_evolve *self,pygsl_odeiv2_control *con,pygsl_odeiv2_step *step,pygsl_odeiv2_system const *sys,double const t_in,double const h0,PyObject *y_in_o){
		...
		dim = self->dimension;
		if(con == NULL){
			pygsl_error("control object not set?", "src/callback/gsl_odeiv2.i", 702, GSL_EINVAL);
			line = 703 - 2; goto fail;
		}
		if(step == NULL){
			pygsl_error("step object not set?", "src/callback/gsl_odeiv2.i", 706, GSL_EINVAL);
			line = 707 - 2; goto fail;
		}
		if(sys == NULL){
			pygsl_error("sys object not set?", "src/callback/gsl_odeiv2.i", 710, GSL_EINVAL);
			line = 711 - 2; goto fail;
		}
		if(sys->dydt.dimension != dim){
			pygsl_error("sys dimension does not match evolve dimension", "src/callback/gsl_odeiv2.i", 714, GSL_EINVAL);
...
SWIGINTERN pygsl_odeiv2_driver *new_pygsl_odeiv2_driver(PyObject *sys_o,gsl_odeiv2_step_type const *T,double const hstart,double const epsabs,double const epsrel,double const a_y,double const a_dydt,PyObject *scale_abs_o){
		...
		if(sys == NULL){
			...
			pygsl_error("sys None/NULL not accepted", "src/callback/gsl_odeiv2.i", 817 -1, GSL_EINVAL);
			goto fail;
		}
		if(T == NULL){
			DEBUG_MESS(2, "T = %p", (void *) T);
			pygsl_error("Type None/NULL not accepted", "src/callback/gsl_odeiv2.i", 822 -1, GSL_EINVAL);
			goto fail;
		}
...
SWIGINTERN int _wrap_new_pygsl_odeiv2_step(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO:new_pygsl_odeiv2_step", kwnames, &obj1, &obj2)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_step_apply(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOO:pygsl_odeiv2_step_apply", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5, &obj6)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_step, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGPY_DESTRUCTOR_CLOSURE(_wrap_delete_pygsl_odeiv2_step) /* defines _wrap_delete_pygsl_odeiv2_step_destructor_closure */
...
SWIGINTERN int _wrap_new_pygsl_odeiv2_control(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOO:new_pygsl_odeiv2_control", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_control_init(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOO:pygsl_odeiv2_control_init", kwnames, &obj1, &obj2, &obj3, &obj4)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_control_hadjust(PyObject *self, PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  pygsl_odeiv2_control *arg1 = (pygsl_odeiv2_control *) 0 ;
  pygsl_odeiv2_step *arg2 = (pygsl_odeiv2_step *) 0 ;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOO:pygsl_odeiv2_control_hadjust", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_control, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "pygsl_odeiv2_control_hadjust" "', argument " "1"" of type '" "pygsl_odeiv2_control *""'"); 
  }
  arg1 = (pygsl_odeiv2_control *)(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_pygsl_odeiv2_step, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "pygsl_odeiv2_control_hadjust" "', argument " "2"" of type '" "pygsl_odeiv2_step *""'"); 
  }
  arg2 = (pygsl_odeiv2_step *)(argp2);
  arg3 = obj2;
  arg4 = obj3;
  arg5 = obj4;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_control_errlevel(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOO:pygsl_odeiv2_control_errlevel", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_control, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGPY_DESTRUCTOR_CLOSURE(_wrap_delete_pygsl_odeiv2_control) /* defines _wrap_delete_pygsl_odeiv2_control_destructor_closure */
...
SWIGINTERN int _wrap_new_pygsl_odeiv2_evolve(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:new_pygsl_odeiv2_evolve", kwnames, &obj1)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_evolve_apply(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOO:pygsl_odeiv2_evolve_apply", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5, &obj6, &obj7)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_evolve, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_evolve_apply_fixed_step(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOO:pygsl_odeiv2_evolve_apply_fixed_step", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5, &obj6)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_evolve, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGPY_DESTRUCTOR_CLOSURE(_wrap_delete_pygsl_odeiv2_evolve) /* defines _wrap_delete_pygsl_odeiv2_evolve_destructor_closure */
...
SWIGINTERN int _wrap_new_pygsl_odeiv2_driver(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOOO:new_pygsl_odeiv2_driver", kwnames, &obj1, &obj2, &obj3, &obj4, &obj5, &obj6, &obj7, &obj8)) SWIG_fail;
  arg1 = obj1;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_driver_set_hmin(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:pygsl_odeiv2_driver_set_hmin", kwnames, &obj1)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_driver_set_hmax(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:pygsl_odeiv2_driver_set_hmax", kwnames, &obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_driver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_driver_set_nmax(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:pygsl_odeiv2_driver_set_nmax", kwnames, &obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_driver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_driver_reset_hstart(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:pygsl_odeiv2_driver_reset_hstart", kwnames, &obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_driver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_driver_apply_fixed_step(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOO:pygsl_odeiv2_driver_apply_fixed_step", kwnames, &obj1, &obj2, &obj3, &obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_driver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_pygsl_odeiv2_driver_apply(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOO:pygsl_odeiv2_driver_apply", kwnames, &obj1, &obj2, &obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pygsl_odeiv2_driver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGPY_DESTRUCTOR_CLOSURE(_wrap_delete_pygsl_odeiv2_driver) /* defines _wrap_delete_pygsl_odeiv2_driver_destructor_closure */
...
static PyHeapTypeObject SwigPyBuiltin__pygsl_odeiv2_system_type = {
  {
    ...
    (inquiry) 0,                              /* tp_clear */
    SwigPyBuiltin__pygsl_odeiv2_system_richcompare,               /* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__pygsl_odeiv2_step_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_FunpackGetterClosure, 0, (char *)"pygsl_odeiv2_step : p.pygsl_odeiv2_step", &pygsl_odeiv2_step___dict___getset },
    { NULL, NULL, NULL, NULL, NULL } /* Sentinel */
};
...
SWIGINTERN PyMethodDef SwigPyBuiltin__pygsl_odeiv2_step_methods[] = {
  { "reset", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_step_reset, METH_VARARGS|METH_KEYWORDS, "reset(pygsl_odeiv2_step self) -> gsl_error_flag_drop" },
  { "name", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_step_name, METH_VARARGS|METH_KEYWORDS, "name(pygsl_odeiv2_step self) -> char const *" },
  { "order", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_step_order, METH_VARARGS|METH_KEYWORDS, "order(pygsl_odeiv2_step self) -> unsigned int" },
  { "apply", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_step_apply, METH_VARARGS|METH_KEYWORDS, "\n"
...
static PyHeapTypeObject SwigPyBuiltin__pygsl_odeiv2_step_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    _wrap_delete_pygsl_odeiv2_step_destructor_closure,            /* tp_dealloc */
    (printfunc) 0,                            /* tp_print */
    (getattrfunc) 0,                          /* tp_getattr */
    (setattrfunc) 0,                          /* tp_setattr */
#if PY_VERSION_HEX >= 0x03000000
    ...
    (traverseproc) 0,                         /* tp_traverse */
    (inquiry) 0,                              /* tp_clear */
    SwigPyBuiltin__pygsl_odeiv2_step_richcompare,                 /* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
    (getiterfunc) 0,                          /* tp_iter */
    (iternextfunc) 0,                         /* tp_iternext */
    ...
    (descrsetfunc) 0,                         /* tp_descr_set */
    offsetof(SwigPyObject, dict),             /* tp_dictoffset */
    _wrap_new_pygsl_odeiv2_step,              /* tp_init */
    (allocfunc) 0,                            /* tp_alloc */
    (newfunc) 0,                              /* tp_new */
    (freefunc) 0,                             /* tp_free */
    (inquiry) 0,                              /* tp_is_gc */
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__pygsl_odeiv2_control_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_FunpackGetterClosure, 0, (char *)"pygsl_odeiv2_control : p.pygsl_odeiv2_control", &pygsl_odeiv2_control___dict___getset },
    { NULL, NULL, NULL, NULL, NULL } /* Sentinel */
};
...
SWIGINTERN PyMethodDef SwigPyBuiltin__pygsl_odeiv2_control_methods[] = {
  { "init", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_control_init, METH_VARARGS|METH_KEYWORDS, "\n"
		...
		"\n"
		"" },
  { "name", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_control_name, METH_VARARGS|METH_KEYWORDS, "name(pygsl_odeiv2_control self) -> char const *" },
  { "hadjust", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_control_hadjust, METH_VARARGS|METH_KEYWORDS, "\n"
		...
		"\n"
		"" },
  { "errlevel", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_control_errlevel, METH_VARARGS|METH_KEYWORDS, "\n"
...
static PyHeapTypeObject SwigPyBuiltin__pygsl_odeiv2_control_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    _wrap_delete_pygsl_odeiv2_control_destructor_closure,         /* tp_dealloc */
    (printfunc) 0,                            /* tp_print */
    (getattrfunc) 0,                          /* tp_getattr */
    (setattrfunc) 0,                          /* tp_setattr */
#if PY_VERSION_HEX >= 0x03000000
    ...
    (traverseproc) 0,                         /* tp_traverse */
    (inquiry) 0,                              /* tp_clear */
    SwigPyBuiltin__pygsl_odeiv2_control_richcompare,              /* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
    (getiterfunc) 0,                          /* tp_iter */
    (iternextfunc) 0,                         /* tp_iternext */
    ...
    (descrsetfunc) 0,                         /* tp_descr_set */
    offsetof(SwigPyObject, dict),             /* tp_dictoffset */
    _wrap_new_pygsl_odeiv2_control,           /* tp_init */
    (allocfunc) 0,                            /* tp_alloc */
    (newfunc) 0,                              /* tp_new */
    (freefunc) 0,                             /* tp_free */
    (inquiry) 0,                              /* tp_is_gc */
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__pygsl_odeiv2_evolve_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_FunpackGetterClosure, 0, (char *)"pygsl_odeiv2_evolve : p.pygsl_odeiv2_evolve", &pygsl_odeiv2_evolve___dict___getset },
    { NULL, NULL, NULL, NULL, NULL } /* Sentinel */
};
...
SWIGINTERN PyMethodDef SwigPyBuiltin__pygsl_odeiv2_evolve_methods[] = {
  { "reset", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_evolve_reset, METH_VARARGS|METH_KEYWORDS, "reset(pygsl_odeiv2_evolve self) -> gsl_error_flag_drop" },
  { "get_yerr", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_evolve_get_yerr, METH_VARARGS|METH_KEYWORDS, "get_yerr(pygsl_odeiv2_evolve self) -> PyObject *" },
  { "apply", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_evolve_apply, METH_VARARGS|METH_KEYWORDS, "\n"
		...
		"\n"
		"" },
  { "apply_fixed_step", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_evolve_apply_fixed_step, METH_VARARGS|METH_KEYWORDS, "\n"
...
static PyHeapTypeObject SwigPyBuiltin__pygsl_odeiv2_evolve_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    _wrap_delete_pygsl_odeiv2_evolve_destructor_closure,          /* tp_dealloc */
    (printfunc) 0,                            /* tp_print */
    (getattrfunc) 0,                          /* tp_getattr */
    (setattrfunc) 0,                          /* tp_setattr */
#if PY_VERSION_HEX >= 0x03000000
    ...
    (traverseproc) 0,                         /* tp_traverse */
    (inquiry) 0,                              /* tp_clear */
    SwigPyBuiltin__pygsl_odeiv2_evolve_richcompare,               /* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
    (getiterfunc) 0,                          /* tp_iter */
    (iternextfunc) 0,                         /* tp_iternext */
    ...
    (descrsetfunc) 0,                         /* tp_descr_set */
    offsetof(SwigPyObject, dict),             /* tp_dictoffset */
    _wrap_new_pygsl_odeiv2_evolve,            /* tp_init */
    (allocfunc) 0,                            /* tp_alloc */
    (newfunc) 0,                              /* tp_new */
    (freefunc) 0,                             /* tp_free */
    (inquiry) 0,                              /* tp_is_gc */
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__pygsl_odeiv2_driver_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_FunpackGetterClosure, 0, (char *)"~pygsl_odeiv2_driver : void", &pygsl_odeiv2_driver___dict___getset },
    { NULL, NULL, NULL, NULL, NULL } /* Sentinel */
};
...
SWIGINTERN PyMethodDef SwigPyBuiltin__pygsl_odeiv2_driver_methods[] = {
  { "set_hmin", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_set_hmin, METH_VARARGS|METH_KEYWORDS, "\n"
		"set_hmin(pygsl_odeiv2_driver self, double const h_min) -> gsl_error_flag_drop\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"h_min: double const\n"
		"\n"
		"" },
  { "set_hmax", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_set_hmax, METH_VARARGS|METH_KEYWORDS, "\n"
		"set_hmax(pygsl_odeiv2_driver self, double const h_max) -> gsl_error_flag_drop\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"h_max: double const\n"
		"\n"
		"" },
  { "set_nmax", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_set_nmax, METH_VARARGS|METH_KEYWORDS, "\n"
		"set_nmax(pygsl_odeiv2_driver self, unsigned long const nmax) -> gsl_error_flag_drop\n"
		"\n"
		"Parameters\n"
		"----------\n"
		...
		"\n"
		"" },
  { "reset", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_reset, METH_VARARGS|METH_KEYWORDS, "reset(pygsl_odeiv2_driver self) -> gsl_error_flag_drop" },
  { "reset_hstart", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_reset_hstart, METH_VARARGS|METH_KEYWORDS, "\n"
		"reset_hstart(pygsl_odeiv2_driver self, double const hstart) -> gsl_error_flag_drop\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"hstart: double const\n"
		"\n"
		"" },
  { "apply_fixed_step", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_apply_fixed_step, METH_VARARGS|METH_KEYWORDS, "\n"
		"apply_fixed_step(pygsl_odeiv2_driver self, double const tin, double const h, unsigned long const n, PyObject * y_o) -> PyObject *\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"tin: double const\n"
		...
		"\n"
		"" },
  { "apply", (PyCFunction)(void(*)(void))_wrap_pygsl_odeiv2_driver_apply, METH_VARARGS|METH_KEYWORDS, "\n"
		"apply(pygsl_odeiv2_driver self, double const tin, double const t1, PyObject * y_o) -> PyObject *\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"tin: double const\n"
...
static PyHeapTypeObject SwigPyBuiltin__pygsl_odeiv2_driver_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    _wrap_delete_pygsl_odeiv2_driver_destructor_closure,          /* tp_dealloc */
    (printfunc) 0,                            /* tp_print */
    (getattrfunc) 0,                          /* tp_getattr */
    (setattrfunc) 0,                          /* tp_setattr */
#if PY_VERSION_HEX >= 0x03000000
    ...
    (traverseproc) 0,                         /* tp_traverse */
    (inquiry) 0,                              /* tp_clear */
    SwigPyBuiltin__pygsl_odeiv2_driver_richcompare,               /* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
    (getiterfunc) 0,                          /* tp_iter */
    (iternextfunc) 0,                         /* tp_iternext */
    ...
    (descrsetfunc) 0,                         /* tp_descr_set */
    offsetof(SwigPyObject, dict),             /* tp_dictoffset */
    _wrap_new_pygsl_odeiv2_driver,            /* tp_init */
    (allocfunc) 0,                            /* tp_alloc */
    (newfunc) 0,                              /* tp_new */
    (freefunc) 0,                             /* tp_free */
    (inquiry) 0,                              /* tp_is_gc */
