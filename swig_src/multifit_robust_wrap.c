...
SWIGINTERN int _wrap_new_stats(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"new_stats",0,0,0)) SWIG_fail;
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__gsl_multifit_robust_stats_getset[] = {
    { (char *) "__dict__", (getter) SwigPyBuiltin_FunpackGetterClosure, (setter) 0, (char *)"gsl_multifit_robust_stats.__dict__", (void *) &stats___dict___getset }
,
...
static PyHeapTypeObject SwigPyBuiltin__gsl_multifit_robust_stats_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    (destructor) (destructor) _wrap_delete_stats_destructor_closure,/* tp_dealloc */
    ...
    (inquiry) 0,                              /* tp_clear */
    (richcmpfunc) SwigPyBuiltin__gsl_multifit_robust_stats_richcompare,/* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__gsl_multifit_robust_workspace_getset[] = {
    { (char *) "__dict__", (getter) SwigPyBuiltin_FunpackGetterClosure, (setter) 0, (char *)"gsl_multifit_robust_workspace.__dict__", (void *) &workspace___dict___getset }
,
    {NULL, NULL, NULL, NULL, NULL} /* Sentinel */
};
...
static PyHeapTypeObject SwigPyBuiltin__gsl_multifit_robust_workspace_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    (destructor) (destructor) _wrap_delete_workspace_destructor_closure,/* tp_dealloc */
    (printfunc) 0,                            /* tp_print */
    (getattrfunc) 0,                          /* tp_getattr */
    (setattrfunc) 0,                          /* tp_setattr */
#if PY_VERSION_HEX >= 0x03000000
    ...
    (traverseproc) 0,                         /* tp_traverse */
    (inquiry) 0,                              /* tp_clear */
    (richcmpfunc) SwigPyBuiltin__gsl_multifit_robust_workspace_richcompare,/* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
    (getiterfunc) 0,                          /* tp_iter */
    (iternextfunc) 0,                         /* tp_iternext */
