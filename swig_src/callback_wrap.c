...
SWIGINTERN PyObject *_wrap_pygsl_multifit_linear_residuals(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"OOO:pygsl_multifit_linear_residuals",kwnames,&obj0,&obj1,&obj2)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gsl_cheb_alloc", (PyCFunction) _wrap_gsl_cheb_alloc, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_alloc(size_t const order) -> gsl_cheb_series *"},
	 { (char *)"gsl_cheb_free", (PyCFunction) _wrap_gsl_cheb_free, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_free(gsl_cheb_series * cs)"},
	 { (char *)"gsl_cheb_init", (PyCFunction) _wrap_gsl_cheb_init, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_init(gsl_cheb_series * cs, gsl_function const * BUFFER, double const a, double const b) -> int"},
	 { (char *)"gsl_cheb_eval", (PyCFunction) _wrap_gsl_cheb_eval, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_eval(gsl_cheb_series const * cs, double const x) -> double"},
	 { (char *)"gsl_cheb_eval_err", (PyCFunction) _wrap_gsl_cheb_eval_err, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_eval_err(gsl_cheb_series const * cs, double const x) -> int"},
	 { (char *)"gsl_cheb_eval_n", (PyCFunction) _wrap_gsl_cheb_eval_n, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_eval_n(gsl_cheb_series const * cs, size_t const order, double const x) -> double"},
	 { (char *)"gsl_cheb_eval_n_err", (PyCFunction) _wrap_gsl_cheb_eval_n_err, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_eval_n_err(gsl_cheb_series const * cs, size_t const order, double const x) -> int"},
	 { (char *)"gsl_cheb_calc_deriv", (PyCFunction) _wrap_gsl_cheb_calc_deriv, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_calc_deriv(gsl_cheb_series * deriv, gsl_cheb_series const * cs) -> int"},
	 { (char *)"gsl_cheb_calc_integ", (PyCFunction) _wrap_gsl_cheb_calc_integ, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_cheb_calc_integ(gsl_cheb_series * integ, gsl_cheb_series const * cs) -> int"},
	 { (char *)"pygsl_cheb_get_coefficients", (PyCFunction) _wrap_pygsl_cheb_get_coefficients, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_get_coefficients(gsl_cheb_series * s) -> PyObject *"},
	 { (char *)"pygsl_cheb_set_coefficients", (PyCFunction) _wrap_pygsl_cheb_set_coefficients, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_set_coefficients(gsl_cheb_series * s, gsl_vector * IN) -> int"},
	 { (char *)"pygsl_cheb_get_a", (PyCFunction) _wrap_pygsl_cheb_get_a, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_get_a(gsl_cheb_series * s) -> double"},
	 { (char *)"pygsl_cheb_get_b", (PyCFunction) _wrap_pygsl_cheb_get_b, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_get_b(gsl_cheb_series * s) -> double"},
	 { (char *)"pygsl_cheb_set_a", (PyCFunction) _wrap_pygsl_cheb_set_a, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_set_a(gsl_cheb_series * s, double a)"},
	 { (char *)"pygsl_cheb_set_b", (PyCFunction) _wrap_pygsl_cheb_set_b, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_set_b(gsl_cheb_series * s, double b)"},
	 { (char *)"pygsl_cheb_get_order_sp", (PyCFunction) _wrap_pygsl_cheb_get_order_sp, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_get_order_sp(gsl_cheb_series * s) -> size_t"},
	 { (char *)"pygsl_cheb_set_order_sp", (PyCFunction) _wrap_pygsl_cheb_set_order_sp, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_set_order_sp(gsl_cheb_series * s, size_t sp)"},
	 { (char *)"pygsl_cheb_get_f", (PyCFunction) _wrap_pygsl_cheb_get_f, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_get_f(gsl_cheb_series * s) -> double"},
	 { (char *)"pygsl_cheb_set_f", (PyCFunction) _wrap_pygsl_cheb_set_f, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_cheb_set_f(gsl_cheb_series * s, double f)"},
	 { (char *)"gsl_odeiv_step_alloc", (PyCFunction) _wrap_gsl_odeiv_step_alloc, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_step_alloc(gsl_odeiv_step_type const * T, size_t dim) -> gsl_odeiv_step *"},
	 { (char *)"gsl_odeiv_step_reset", (PyCFunction) _wrap_gsl_odeiv_step_reset, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_step_reset(gsl_odeiv_step * s) -> int"},
	 { (char *)"gsl_odeiv_step_free", (PyCFunction) _wrap_gsl_odeiv_step_free, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_step_free(gsl_odeiv_step * s)"},
	 { (char *)"gsl_odeiv_step_name", (PyCFunction) _wrap_gsl_odeiv_step_name, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_step_name(gsl_odeiv_step const * arg1) -> char const *"},
	 { (char *)"gsl_odeiv_step_order", (PyCFunction) _wrap_gsl_odeiv_step_order, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_step_order(gsl_odeiv_step const * s) -> unsigned int"},
	 { (char *)"gsl_odeiv_step_apply", pygsl_odeiv_step_apply, METH_VARARGS, NULL},
	 { (char *)"gsl_odeiv_control_alloc", (PyCFunction) _wrap_gsl_odeiv_control_alloc, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_alloc(gsl_odeiv_control_type const * T) -> gsl_odeiv_control *"},
	 { (char *)"gsl_odeiv_control_init", (PyCFunction) _wrap_gsl_odeiv_control_init, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_init(gsl_odeiv_control * c, double eps_abs, double eps_rel, double a_y, double a_dydt) -> int"},
	 { (char *)"gsl_odeiv_control_free", (PyCFunction) _wrap_gsl_odeiv_control_free, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_free(gsl_odeiv_control * c)"},
	 { (char *)"gsl_odeiv_control_hadjust", pygsl_odeiv_control_hadjust, METH_VARARGS, NULL},
	 { (char *)"gsl_odeiv_control_name", (PyCFunction) _wrap_gsl_odeiv_control_name, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_name(gsl_odeiv_control const * c) -> char const *"},
	 { (char *)"gsl_odeiv_control_standard_new", (PyCFunction) _wrap_gsl_odeiv_control_standard_new, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_standard_new(double eps_abs, double eps_rel, double a_y, double a_dydt) -> gsl_odeiv_control *"},
	 { (char *)"gsl_odeiv_control_y_new", (PyCFunction) _wrap_gsl_odeiv_control_y_new, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_y_new(double eps_abs, double eps_rel) -> gsl_odeiv_control *"},
	 { (char *)"gsl_odeiv_control_yp_new", (PyCFunction) _wrap_gsl_odeiv_control_yp_new, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_control_yp_new(double eps_abs, double eps_rel) -> gsl_odeiv_control *"},
	 { (char *)"gsl_odeiv_evolve_alloc", (PyCFunction) _wrap_gsl_odeiv_evolve_alloc, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_evolve_alloc(size_t dim) -> gsl_odeiv_evolve *"},
	 { (char *)"gsl_odeiv_evolve_reset", (PyCFunction) _wrap_gsl_odeiv_evolve_reset, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_evolve_reset(gsl_odeiv_evolve * arg1) -> int"},
	 { (char *)"gsl_odeiv_evolve_free", (PyCFunction) _wrap_gsl_odeiv_evolve_free, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_odeiv_evolve_free(gsl_odeiv_evolve * arg1)"},
	 ...
	 { (char *)"gsl_multifit_linear_alloc", (PyCFunction) _wrap_gsl_multifit_linear_alloc, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_linear_alloc(size_t n, size_t p) -> gsl_multifit_linear_workspace *"},
	 { (char *)"gsl_multifit_linear_free", (PyCFunction) _wrap_gsl_multifit_linear_free, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_linear_free(gsl_multifit_linear_workspace * work)"},
	 { (char *)"gsl_multifit_linear", (PyCFunction) _wrap_gsl_multifit_linear, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_linear(gsl_matrix const * IN_AND_SIZE, gsl_vector const * IN, gsl_multifit_linear_workspace * work_provide) -> gsl_error_flag_drop"},
	 { (char *)"gsl_multifit_wlinear", (PyCFunction) _wrap_gsl_multifit_wlinear, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_wlinear(gsl_matrix const * IN_AND_SIZE, gsl_vector const * w, gsl_vector const * y, gsl_multifit_linear_workspace * work_provide) -> gsl_error_flag_drop"},
	 { (char *)"gsl_multifit_wlinear_svd", (PyCFunction) _wrap_gsl_multifit_wlinear_svd, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_wlinear_svd(gsl_matrix const * IN_AND_SIZE, gsl_vector const * w, gsl_vector const * y, double TOL, gsl_multifit_linear_workspace * work_provide) -> gsl_error_flag_drop"},
	 { (char *)"gsl_multifit_linear_est", (PyCFunction) _wrap_gsl_multifit_linear_est, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_linear_est(gsl_vector const * x, gsl_vector const * c, gsl_matrix const * IN) -> gsl_error_flag_drop"},
	 { (char *)"gsl_multifit_linear_est_matrix", (PyCFunction) _wrap_gsl_multifit_linear_est_matrix, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_multifit_linear_est_matrix(gsl_matrix const * x, gsl_vector const * c, gsl_matrix const * cov) -> PyObject *"},
	 { (char *)"pygsl_multifit_linear_residuals", (PyCFunction) _wrap_pygsl_multifit_linear_residuals, METH_VARARGS | METH_KEYWORDS, (char *)"pygsl_multifit_linear_residuals(gsl_matrix const * X, gsl_vector const * y, gsl_vector const * c) -> PyObject *"},
	 { (char *)"gsl_fit_linear", (PyCFunction) _wrap_gsl_fit_linear, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_fit_linear(double const * x, double const * y) -> gsl_error_flag_drop"},
	 { (char *)"gsl_fit_wlinear", (PyCFunction) _wrap_gsl_fit_wlinear, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_fit_wlinear(double const * x, double const * w, double const * y) -> gsl_error_flag_drop"},
	 { (char *)"gsl_fit_linear_est", (PyCFunction) _wrap_gsl_fit_linear_est, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_fit_linear_est(double const x, double const c0, double const c1, double const c00, double const c01, double const c11) -> gsl_error_flag_drop"},
	 { (char *)"gsl_fit_mul", (PyCFunction) _wrap_gsl_fit_mul, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_fit_mul(double const * x, double const * y) -> gsl_error_flag_drop"},
	 { (char *)"gsl_fit_wmul", (PyCFunction) _wrap_gsl_fit_wmul, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_fit_wmul(double const * x, double const * w, double const * y) -> gsl_error_flag_drop"},
	 { (char *)"gsl_fit_mul_est", (PyCFunction) _wrap_gsl_fit_mul_est, METH_VARARGS | METH_KEYWORDS, (char *)"gsl_fit_mul_est(double const x, double const c1, double const c11) -> gsl_error_flag_drop"},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char *)"gsl_multimin_fminimizer_nmsimplex2",Swig_var_gsl_multimin_fminimizer_nmsimplex2_get, Swig_var_gsl_multimin_fminimizer_nmsimplex2_set);
  PyDict_SetItemString(md, (char *)"gsl_multimin_fminimizer_nmsimplex2", PyObject_GetAttrString(SWIG_globals(), "gsl_multimin_fminimizer_nmsimplex2"));
  SwigPyBuiltin_AddPublicSymbol(public_interface, "gsl_multimin_fminimizer_nmsimplex2");
  SWIG_addvarlink(SWIG_globals(),(char *)"gsl_multimin_fminimizer_nmsimplex2rand",Swig_var_gsl_multimin_fminimizer_nmsimplex2rand_get, Swig_var_gsl_multimin_fminimizer_nmsimplex2rand_set);
  PyDict_SetItemString(md, (char *)"gsl_multimin_fminimizer_nmsimplex2rand", PyObject_GetAttrString(SWIG_globals(), "gsl_multimin_fminimizer_nmsimplex2rand"));
  SwigPyBuiltin_AddPublicSymbol(public_interface, "gsl_multimin_fminimizer_nmsimplex2rand");
  SWIG_addvarlink(SWIG_globals(),(char *)"gsl_multimin_fdfminimizer_vector_bfgs2",Swig_var_gsl_multimin_fdfminimizer_vector_bfgs2_get, Swig_var_gsl_multimin_fdfminimizer_vector_bfgs2_set);
  PyDict_SetItemString(md, (char *)"gsl_multimin_fdfminimizer_vector_bfgs2", PyObject_GetAttrString(SWIG_globals(), "gsl_multimin_fdfminimizer_vector_bfgs2"));
