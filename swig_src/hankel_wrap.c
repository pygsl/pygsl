...
SWIGINTERN PyGetSetDef SwigPyBuiltin__gsl_dht_struct_getset[] = {
    { (char *) "__dict__", (getter) SwigPyBuiltin_FunpackGetterClosure, (setter) 0, (char *)"gsl_dht_struct.__dict__", (void *) &DiscreteHankelTransform___dict___getset }
,
...
static PyHeapTypeObject SwigPyBuiltin__gsl_dht_struct_type = {
  {
    ...
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
    (destructor) (destructor) _wrap_delete_DiscreteHankelTransform_destructor_closure,/* tp_dealloc */
    ...
    (inquiry) 0,                              /* tp_clear */
    (richcmpfunc) SwigPyBuiltin__gsl_dht_struct_richcompare,      /* tp_richcompare */
    0,                                        /* tp_weaklistoffset */
