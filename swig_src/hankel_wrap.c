...
#define  SWIGTYPE_p_gsl_dht_struct swig_types[0] 
...
void delete_gsl_dht_struct(struct gsl_dht_struct *self){
    gsl_dht_free(self);
  }
...
PyObject *gsl_dht_struct_apply(struct gsl_dht_struct *self,PyObject *in){
...
static PyObject *_wrap_DiscreteHankelTransform_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if(!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"Odd:DiscreteHankelTransform_init",kwnames,&obj0,&arg2,&arg3)) goto fail;
    if ((SWIG_ConvertPtr(obj0,(void **) &arg1, SWIGTYPE_p_gsl_dht_struct,SWIG_POINTER_EXCEPTION | 0 )) == -1) SWIG_fail;
...
static swig_type_info _swigt__p_gsl_dht_struct[] = {{"_p_gsl_dht_struct", 0, "gsl_dht_struct *", 0},{"_p_gsl_dht_struct"},{0}};
