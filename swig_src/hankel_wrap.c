...
SWIGINTERN PyObject *gsl_dht_struct_apply(struct gsl_dht_struct *self,PyObject *in){
...
static swig_type_info _swigt__p_gsl_dht_struct = {"_p_gsl_dht_struct", "gsl_dht_struct *", 0, 0, (void*)0, 0};
