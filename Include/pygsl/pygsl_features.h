 ...
 *
 * But testing with GSL 2.0
 */
#if PYGSL_GSL_MAJOR_VERSION == 1
#else
#warning "Testing for version 2.?"
 ...
 */
#if  (PYGSL_GSL_MAJOR_VERSION > 1) ||  (PYGSL_GSL_MAJOR_VERSION  == 1 && PYGSL_GSL_MINOR_VERSION >= 3)	
 ...
 * The wavelet module
 */
#if (PYGSL_GSL_MAJOR_VERSION > 1) ||  (PYGSL_GSL_MAJOR_VERSION  == 1 && (PYGSL_GSL_MINOR_VERSION > 5))
 ...
 */
#if (PYGSL_GSL_MAJOR_VERSION > 1) || (PYGSL_GSL_MINOR_VERSION > 8)
 ...
 */
#if (PYGSL_GSL_MAJOR_VERSION > 1) || (PYGSL_GSL_MINOR_VERSION < 4) || (PYGSL_GSL_MINOR_VERSION > 5)
